...
public class StockWatcher implements EntryPoint {
 ...
 // Listen for mouse events on the Add button.
  ...
  private void loadStocks() {  
	  stockService.getStocks(new AsyncCallback<String[]>() {  public void onFailure(Throwable error) { handleError(error); }  public void onSuccess(String[] symbols) {  displayStocks(symbols);  }  });  }
 ...
 // Display timestamp showing last refresh.
    lastUpdatedLabel.setText("The last time updated : "  + DateTimeFormat.getMediumDateTimeFormat().format(new Date()));
  }
